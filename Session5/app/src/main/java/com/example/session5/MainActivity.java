...
public class MainActivity extends AppCompatActivity {
    private IApiService apiService; private ViewPager2 viewPager2; private androidx.recyclerview.widget.RecyclerView eventsList;
    private EventsAdapter eventsAdapter; private NewsAdapter newsAdapter;
    private NewsPagerAdapter NewsPagerAdapter; private NewsViewModel newsViewModel;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Retrofit retrofit = new Retrofit.Builder()
                .baseUrl("http://api.fadeev.website:5000/")
